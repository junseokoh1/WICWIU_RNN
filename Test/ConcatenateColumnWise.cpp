...
int main(int argc, char const *argv[]) {
    Tensorholder<float> *input0 = new Tensorholder<float>(Tensor<float>::Random_normal(1, 1, 1, 1, 10, 0.0, 0.1), "x");
    Tensorholder<float> *input1 = new Tensorholder<float>(Tensor<float>::Random_normal(1, 1, 1, 1, 2, 0.0, 0.1), "label");
    ...
    Operator<float> *concat = new ConcatenateColumnWise<float>(input0, input1);
