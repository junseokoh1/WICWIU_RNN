...
int main(int argc, char const *argv[]) {
    ...
    Tensorholder<float> *pWeight_x2h = new Tensorholder<float>(Tensor<float>::Random_normal(1, 1, 1, hidden_size, input_size, 0.0, 0.1), "RecurrentLayer_pWeight_x2h_");
...
/*
    //cudnn 때문에 해보는거 weight 3개로 합쳐보기
    (*(pWeight_h2h->GetResult()))[5] = -1;
    (*(pWeight_h2h->GetResult()))[4] = 0.4;
    (*(pWeight_h2h->GetResult()))[6] = 0.5;
    (*(pWeight_h2h->GetResult()))[7] = 0.3;

    (*(pWeight_h2h->GetResult()))[1] = 0.3;
    (*(pWeight_h2h->GetResult()))[0] = 0.03;
    (*(pWeight_h2h->GetResult()))[7] = 0.25;
    (*(pWeight_h2h->GetResult()))[6] = 0.2;

    (*(pWeight_h2h->GetResult()))[8] = -0.5;
    (*(pWeight_h2h->GetResult()))[9] = -1.4;
    (*(pWeight_h2h->GetResult()))[10] = 1.3;
