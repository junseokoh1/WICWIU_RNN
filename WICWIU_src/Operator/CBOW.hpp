#ifndef CBOW_H_
#define CBOW_H_    value

#include "../Operator.hpp"
#include <cstdio>

template<typename DTYPE> class CBOW : public Operator<DTYPE>{
private:
...
public:
    ...
    CBOW(Operator<DTYPE> *pInput, Operator<DTYPE> *pWeight_in, Operator<DTYPE> *pWeight_out, std::string pName, int pLoadflag = TRUE) : Operator<DTYPE>(pInput, pWeight_in, pWeight_out, pName, pLoadflag) {
        #ifdef __DEBUG__
        std::cout << "CBOW::CBOW(Operator<DTYPE> *, Operator<DTYPE> *, std::string)" << '\n';
        #endif  // __DEBUG__
    ...
    int Alloc(Operator<DTYPE> *pInput, Operator<DTYPE> *pWeight_in, Operator<DTYPE> *pWeight_out) {
        #ifdef __DEBUG__
        std::cout << "CBOW::Alloc(Operator<DTYPE> *, Operator<DTYPE> *)" << '\n';
        #endif  // __DEBUG__
        ...
        m_aInput2Hidden1     = new MatMul<DTYPE>(pWeight_in, m_aTempInput1, "cbow_matmul_win");
        m_aInput2Hidden2     = new MatMul<DTYPE>(pWeight_in, m_aTempInput2, "cbow_matmul_win");
