...
public:
    BatchTextData(string File_Path, int vocab_length, , int batchsize, OPTION pOption) {
        vocab = NULL;
        TextData = NULL;
        wordTextData = NULL;
...
template<typename DTYPE> void BatchTextData<DTYPE>::Alloc(string File_Path) {
...
template<typename DTYPE> void BatchTextData<DTYPE>::Delete() {
    delete []vocab;
    delete []TextData;
}

template<typename DTYPE> void BatchTextData<DTYPE>::FileReader(string pFile_Path) {
    ifstream fin;
    fin.open(pFile_Path);
...
template<typename DTYPE> void BatchTextData<DTYPE>::MakeVocab(){
...
template<typename DTYPE> void BatchTextData<DTYPE>::MakeInputData(){
...
template<typename DTYPE> void BatchTextData<DTYPE>::MakeLabelData(){
...
template<typename DTYPE> void BatchTextData<DTYPE>::MakeCBOWInputData(){
...
template<typename DTYPE> void BatchTextData<DTYPE>::MakeCBOWLabelData(){
...
template<typename DTYPE> int BatchTextData<DTYPE>::char2index(string str){
...
template<typename DTYPE> char BatchTextData<DTYPE>::index2char(int index){

    return vocab[index];
}

template<typename DTYPE> Tensor<DTYPE>* BatchTextData<DTYPE>::GetInputData(){

    return input;
}

template<typename DTYPE> Tensor<DTYPE>* BatchTextData<DTYPE>::GetLabelData(){
    return label;
}

template<typename DTYPE> int BatchTextData<DTYPE>::GetTextLength(){
    return text_length;
}

template<typename DTYPE> int BatchTextData<DTYPE>::GetWordNum(){
    return word_num;
}

template<typename DTYPE> int BatchTextData<DTYPE>::GetVocabLength(){
    return vocab_size;
}
